...
alter table Artikal modify barKod varchar(13) unique;
...
alter table ulaznafaktura drop column brojRacuna;
alter table ulaznafaktura drop column vrstaTransakcije;
alter table ulaznafaktura drop column cijena;
alter table ulaznafaktura drop column kupac;
alter table ulaznafaktura drop column datum;
alter table ulaznafaktura add column identifikator numeric(6); 
alter table ulaznafaktura add column nazivRobe varchar(15);
alter table ulaznafaktura modify column nazivRobe varchar(150);
alter table ulaznafaktura add column prodajnaVrijednost decimal(10,2);
alter table ulaznafaktura add column prodajnaCijena decimal(10,2);
alter table ulaznafaktura modify column identifikator numeric(6); 
alter table artikal add column identifikator numeric(6) unique; 
alter table oprema add column identifikator numeric(6) unique; 
drop table ulaznafaktura_artikal;
drop table ulaznafaktura_oprema;
alter table ulaznafaktura add column brojFakture int;
